...
public class FakewaterFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("palamod:blocks/fakewater_still"),
					FLOWING_TEXTURE = new ResourceLocation("palamod:blocks/fake_water");
