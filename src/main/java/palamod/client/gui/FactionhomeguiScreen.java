...
public class FactionhomeguiScreen extends AbstractContainerScreen<FactionhomeguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Faction home", 116, 3, -12829636);
		this.font.draw(poseStack,
				"Level -  "
						+ ((entity.getCapability(PalamodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
								.orElse(new PalamodModVariables.PlayerVariables())).Faction_max_xp)
						+ " / " + (int) ((entity.getCapability(PalamodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
								.orElse(new PalamodModVariables.PlayerVariables())).Faction_max_xp)
						+ " xp",
				5, 31, -12829636);
		this.font.draw(poseStack, "", 19, 71, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 8, this.topPos + 171, 56, 20, Component.literal("Invite"), e -> {
		}));
	}
}
