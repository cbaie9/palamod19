...
public class ForgeguiScreen extends AbstractContainerScreen<ForgeguiMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 79, this.topPos + 34, 0, 0, 24, 10, 24, 10);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Forge", 79, 4, -13434676);
		this.font.draw(poseStack, "Inventory", 6, 69, -12829636);
	}
