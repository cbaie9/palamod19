...
public class GrinderguiScreen extends AbstractContainerScreen<GrinderguiMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("palamod:textures/screens/arrow_xxl.png"));
		this.blit(ms, this.leftPos + 29, this.topPos + 26, 0, 0, 32, 16, 32, 16);

		RenderSystem.setShaderTexture(0, new ResourceLocation("palamod:textures/screens/arrow_new.png"));
		this.blit(ms, this.leftPos + 27, this.topPos + 74, 0, 0, 24, 10, 24, 10);
		...
		this.blit(ms, this.leftPos + 102, this.topPos + 9, 0, 0, 64, 64, 64, 64);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "" + (PalamodModVariables.g_num) + " /100", 82, 100, -12829636);
		this.font.draw(poseStack, "Inventory", 6, 101, -12829636);
	}
