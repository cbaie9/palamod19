...
public class PalamachineguiScreen extends AbstractContainerScreen<PalamachineguiMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 78, this.topPos + 36, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "PalaMachine", 59, 5, -3407872);
		this.font.draw(poseStack, "Inventory", 4, 72, -12829636);
	}
