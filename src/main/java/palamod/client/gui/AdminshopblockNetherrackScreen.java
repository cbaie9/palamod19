...
public class AdminshopblockNetherrackScreen extends AbstractContainerScreen<AdminshopblockNetherrackMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Netherrack", 58, 6, -12829636);
		this.font.draw(poseStack, "Mode set :", 29, 74, -12829636);
		this.font.draw(poseStack, "Sell price : 0.1", 38, 23, -12829636);
		this.font.draw(poseStack, "Buy price : 1", 44, 36, -12829636);
	}
