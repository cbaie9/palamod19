...
public class LuckyguiScreen extends AbstractContainerScreen<LuckyguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Lucky block", 56, 5, -65536);
		this.font.draw(poseStack, "" + (PalamodModVariables.lucky_name) + "", 26, 84, -3407821);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 119, this.topPos + 53, 45, 20, Component.literal("open"), e -> {
			if (true) {
