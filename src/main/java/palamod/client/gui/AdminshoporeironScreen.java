...
public class AdminshoporeironScreen extends AbstractContainerScreen<AdminshoporeironMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Iron", 58, 6, -12829636);
		this.font.draw(poseStack, "Mode set :", 29, 74, -12829636);
		this.font.draw(poseStack, "", 34, 22, -12829636);
		this.font.draw(poseStack, "Sell price : 15", 35, 24, -12829636);
		this.font.draw(poseStack, "Buy price :  20", 39, 36, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 26, this.topPos + 106, 40, 20, Component.literal("buy"), e -> {
			if (true) {
