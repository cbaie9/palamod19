...
public class AdminshopblockGlowstoneScreen extends AbstractContainerScreen<AdminshopblockGlowstoneMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Glowstone", 58, 6, -12829636);
		this.font.draw(poseStack, "Mode set :", 29, 74, -12829636);
		this.font.draw(poseStack, "Sell price : 5", 37, 22, -12829636);
		this.font.draw(poseStack, "Buy price : 25", 45, 37, -12829636);
	}
