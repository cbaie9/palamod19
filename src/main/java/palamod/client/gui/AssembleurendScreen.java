...
public class AssembleurendScreen extends AbstractContainerScreen<AssembleurendMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "The assembleur will deleted in the", 8, 9, -12829636);
		this.font.draw(poseStack, "update You can trade it for a ", 9, 21, -12829636);
		this.font.draw(poseStack, "Collectr grinder", 10, 34, -12829636);
	}
