...
public class SpawnpanelScreen extends AbstractContainerScreen<SpawnpanelMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "" + (PalamodModVariables.MapVariables.get(world).coor_spawn) + "", 5, 56, -12829636);
		this.font.draw(poseStack, "Spawn Panel", 46, 2, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 3, this.topPos + 74, 92, 20, Component.literal("change Spawn "), e -> {
			if (true) {
