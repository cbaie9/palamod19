...
public class NextPalahelpguiScreen extends AbstractContainerScreen<NextPalahelpguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Palahelp", 5, 4, -52429);
		this.font.draw(poseStack, "2/2", 4, 102, -16750951);
		this.font.draw(poseStack, "more in the future :)", 63, 111, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 87, this.topPos + 24, 80, 20, Component.literal(" /..Commands"), e -> {
		}));
		this.addRenderableWidget(new Button(this.leftPos + 87, this.topPos + 56, 80, 20, Component.literal("Lucky Stats"), e -> {
		}));
		this.addRenderableWidget(new Button(this.leftPos + 6, this.topPos + 134, 75, 20, Component.literal("(---- Back"), e -> {
			if (true) {
