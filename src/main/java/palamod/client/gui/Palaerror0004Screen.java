...
public class Palaerror0004Screen extends AbstractContainerScreen<Palaerror0004Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Err0r 0004 - Hdv", 45, 3, -12829636);
		this.font.draw(poseStack, "This item has already been bought", 0, 14, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 39, this.topPos + 42, 92, 20, Component.literal("return to hdv"), e -> {
			if (true) {
