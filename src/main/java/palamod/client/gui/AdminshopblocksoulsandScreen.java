...
public class AdminshopblocksoulsandScreen extends AbstractContainerScreen<AdminshopblocksoulsandMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Soulsand", 58, 6, -12829636);
		this.font.draw(poseStack, "Mode set :", 29, 74, -12829636);
		this.font.draw(poseStack, "Sell price : 0.5", 38, 24, -12829636);
		this.font.draw(poseStack, "Buy price :  20", 44, 42, -12829636);
	}
