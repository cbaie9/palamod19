...
public class VoidstoneminerconfigScreen extends AbstractContainerScreen<VoidstoneminerconfigMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Activer le d\u00E9placement automatique", 2, 29, -12829636);
		this.font.draw(poseStack, "De la pierre dans la voidstone", 3, 41, -12829636);
		this.font.draw(poseStack, "Voidstone configuration", 74, 4, -12829636);
	}
	...
	public void init() {
		...
		mv_picon = new Checkbox(this.leftPos + 4, this.topPos + 4, 20, 20, Component.literal(""), false);
