...
public class AlchemycreatorguiScreen extends AbstractContainerScreen<AlchemycreatorguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "nether wart :", 6, 20, -12829636);
		this.font.draw(poseStack, "" + (int) (PalamodModVariables.alchemy) + "", 4, 34, -12829636);
		this.font.draw(poseStack, "Inventory", 5, 66, -12829636);
	}
