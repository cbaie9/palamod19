...
package palamod.world.features.lakes;
...
public class AngelicwaterFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("palamod:angelicwater", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(PalamodModBlocks.ANGELICWATER.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("palamod:angelicwater", CONFIGURED_FEATURE,
