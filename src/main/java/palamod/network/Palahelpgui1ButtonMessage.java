...
public class Palahelpgui1ButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(Palahelpgui1ButtonMessage.class, Palahelpgui1ButtonMessage::buffer, Palahelpgui1ButtonMessage::new,
				Palahelpgui1ButtonMessage::handler);
	}
}
