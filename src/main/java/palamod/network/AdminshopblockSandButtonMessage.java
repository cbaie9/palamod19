...
public class AdminshopblockSandButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshopblockSandButtonMessage.class, AdminshopblockSandButtonMessage::buffer,
				AdminshopblockSandButtonMessage::new, AdminshopblockSandButtonMessage::handler);
	}
}
