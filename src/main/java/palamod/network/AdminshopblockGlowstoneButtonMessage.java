...
public class AdminshopblockGlowstoneButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshopblockGlowstoneButtonMessage.class, AdminshopblockGlowstoneButtonMessage::buffer,
				AdminshopblockGlowstoneButtonMessage::new, AdminshopblockGlowstoneButtonMessage::handler);
	}
}
