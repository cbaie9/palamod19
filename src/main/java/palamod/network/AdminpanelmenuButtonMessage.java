...
public class AdminpanelmenuButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminpanelmenuButtonMessage.class, AdminpanelmenuButtonMessage::buffer, AdminpanelmenuButtonMessage::new,
				AdminpanelmenuButtonMessage::handler);
	}
}
