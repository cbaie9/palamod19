...
public class AdminshoporeButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshoporeButtonMessage.class, AdminshoporeButtonMessage::buffer, AdminshoporeButtonMessage::new,
				AdminshoporeButtonMessage::handler);
	}
}
