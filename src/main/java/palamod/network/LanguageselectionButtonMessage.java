...
public class LanguageselectionButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			FrenchredirectProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			EnglishredirectProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(LanguageselectionButtonMessage.class, LanguageselectionButtonMessage::buffer,
				LanguageselectionButtonMessage::new, LanguageselectionButtonMessage::handler);
	}
}
