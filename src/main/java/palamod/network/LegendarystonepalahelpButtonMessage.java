...
public class LegendarystonepalahelpButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(LegendarystonepalahelpButtonMessage.class, LegendarystonepalahelpButtonMessage::buffer,
				LegendarystonepalahelpButtonMessage::new, LegendarystonepalahelpButtonMessage::handler);
	}
}
