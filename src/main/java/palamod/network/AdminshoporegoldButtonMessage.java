...
public class AdminshoporegoldButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshoporegoldButtonMessage.class, AdminshoporegoldButtonMessage::buffer, AdminshoporegoldButtonMessage::new,
				AdminshoporegoldButtonMessage::handler);
	}
}
