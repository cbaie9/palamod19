...
public class XpbushpalahelpguiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(XpbushpalahelpguiButtonMessage.class, XpbushpalahelpguiButtonMessage::buffer,
				XpbushpalahelpguiButtonMessage::new, XpbushpalahelpguiButtonMessage::handler);
	}
}
