...
public class AdminshopmenuButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshopmenuButtonMessage.class, AdminshopmenuButtonMessage::buffer, AdminshopmenuButtonMessage::new,
				AdminshopmenuButtonMessage::handler);
	}
}
