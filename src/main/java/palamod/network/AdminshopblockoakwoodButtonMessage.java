...
public class AdminshopblockoakwoodButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshopblockoakwoodButtonMessage.class, AdminshopblockoakwoodButtonMessage::buffer,
				AdminshopblockoakwoodButtonMessage::new, AdminshopblockoakwoodButtonMessage::handler);
	}
}
