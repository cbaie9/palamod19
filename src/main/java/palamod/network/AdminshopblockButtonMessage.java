...
public class AdminshopblockButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(AdminshopblockButtonMessage.class, AdminshopblockButtonMessage::buffer, AdminshopblockButtonMessage::new,
				AdminshopblockButtonMessage::handler);
	}
}
