...
public class PalahelpblockButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			OreconnectpalahelpProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {

			TreeconnectpalahelpProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(PalahelpblockButtonMessage.class, PalahelpblockButtonMessage::buffer, PalahelpblockButtonMessage::new,
				PalahelpblockButtonMessage::handler);
	}
}
