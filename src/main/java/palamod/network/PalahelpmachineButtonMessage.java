...
public class PalahelpmachineButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 5) {
			...
			ConnectcrusherpalahelpProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 6) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(PalahelpmachineButtonMessage.class, PalahelpmachineButtonMessage::buffer, PalahelpmachineButtonMessage::new,
				PalahelpmachineButtonMessage::handler);
	}
}
