...
public class CrusherpalahelpguiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(CrusherpalahelpguiButtonMessage.class, CrusherpalahelpguiButtonMessage::buffer,
				CrusherpalahelpguiButtonMessage::new, CrusherpalahelpguiButtonMessage::handler);
	}
}
