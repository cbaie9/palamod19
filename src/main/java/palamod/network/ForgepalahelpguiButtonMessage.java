...
public class ForgepalahelpguiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(ForgepalahelpguiButtonMessage.class, ForgepalahelpguiButtonMessage::buffer, ForgepalahelpguiButtonMessage::new,
				ForgepalahelpguiButtonMessage::handler);
	}
}
