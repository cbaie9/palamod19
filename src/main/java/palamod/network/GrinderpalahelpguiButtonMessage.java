...
public class GrinderpalahelpguiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(GrinderpalahelpguiButtonMessage.class, GrinderpalahelpguiButtonMessage::buffer,
				GrinderpalahelpguiButtonMessage::new, GrinderpalahelpguiButtonMessage::handler);
	}
}
