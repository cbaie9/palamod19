...
public class Grinderpalahelp2guiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(Grinderpalahelp2guiButtonMessage.class, Grinderpalahelp2guiButtonMessage::buffer,
				Grinderpalahelp2guiButtonMessage::new, Grinderpalahelp2guiButtonMessage::handler);
	}
}
